...
export default function AboutPage() {
  return (
    <PageWrapper>
      ...
      <div className="">
        {/* text container  */}
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 text-black md:gap-32 lg:gap-48 xl:gap-64">
          {/* bio  */}
          <div className="flex flex-col gap-12 justify-center">
            <h1 className="font-bold text-2xl">BIOGRAPHY</h1>
            <p className="">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Blanditiis at voluptatibus voluptate, tempore vero fugit numquam
              sed nihil veniam, necessitatibus quis saepe cumque ad ut harum et
              nisi. Eveniet, eos.
            </p>
            {/* BIOGRAPHY QUOTE */}
